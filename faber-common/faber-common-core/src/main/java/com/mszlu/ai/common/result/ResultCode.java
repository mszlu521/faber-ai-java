...
public enum ResultCode {
    ...
    //kb 相关 1600-1699
    DOCUMENT_EXTRACT_ERROR(1602, "文档提取错误"),
    DOCUMENT_TRANSFORM_ERROR(1603, "文档转换错误"),
    DELETE_DOCUMENT_FAILED(1604, "删除文档失败"),
    KNOWLEDGE_BASE_NOT_EMPTY(1605, "知识库不为空"),
    QUERY_PARAM_NOT_FOUND(1606, "查询参数不能为空"),
    VECTOR_DIMENSION_CANNOT_BE_MODIFIED(1601, "向量维度不能修改");
